...
manifest = PluginManifest(
    ...
    plugins=[
        ...
        PluginEntry(
            ...
            name="andor_camera",
            import_path="lightfall_endstation_7011.widgets.andor:AndorControllerPlugin",
            metadata={"priority": 150},
        ),
        PluginEntry(
            type_name="controller",
            name="pimte_camera",
            import_path="lightfall_endstation_7011.widgets.pimte:PIMTEControllerPlugin",
            metadata={"priority": 150},
        ),
        # Controller plugin for detector diodes
        PluginEntry(
            type_name="controller",
            name="detector_diode",
            import_path="lightfall_endstation_7011.widgets.diode:DiodeControllerPlugin",
